...
| 우측 · 행사별 | 이 행사에 누가 참여하고 어디까지 왔나 | 참여 업체·진행률·지출, 펼치면 업체별 |
...
중간에 업체가 더 들어오면 `행사별` 화면에서 그 행사 줄을 펼치고
...
예산 집계와 드릴다운, 백업 왕복, 데이터 이관)은 브라우저 스모크 334건으로
확인되어 있습니다.
